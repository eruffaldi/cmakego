	...
	foreach(name ${ARGV})
		...
		elseif(${name} STREQUAL NOREQUIRED)
			...
			elseif(${name} STREQUAL glib2)
				...
				elseif(isrequired)
					message(FATAL_ERROR Missing glib2)
				endif()		
			elseif(${name} STREQUAL gstreamer)
				...
				elseif(isrequired)
					message(FATAL_ERROR Missing gstreamer)
				endif()		
			...
			elseif(${name} STREQUAL eigen)
				...
				elseif(isrequired)
					message(FATAL_ERROR Missing eigen)
				endif()		
			elseif(${name} STREQUAL glm)
				...
				elseif(isrequired)
					message(FATAL_ERROR Missing glm)
				endif()		
			...
			elseif(${name} STREQUAL assimp)
				...
				elseif(isrequired)
					message(FATAL_ERROR Missing Assimp)
				endif()		
			elseif(${name} STREQUAL opencv)
				...
				if(OpenCV_FOUND)
					...
					#link_directories(${ASSIMP_LIBRARY_DIRS})
				elseif(isrequired)
					message(FATAL_ERROR Missing OpenCV)
				endif()		
